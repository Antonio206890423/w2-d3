...
for (let i = 0; i < starWarsCharacters.length; i++) {
  //console.log(i);
  console.log("Sono i nomi dell'array", starWarsCharacters[i].name);
  charactersNames.push(starWarsCharacters[i].name);
}
console.log("Push", charactersNames);
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  if (starWarsCharacters[i].gender === "female") {
    console.log("Gli oggetti femminili sono:", starWarsCharacters[i]);
    femaleCharacters.push(starWarsCharacters[i]);
  }
}
console.log("Push", femaleCharacters);
...
console.log("Divisione per colore di occhi", eyeColor);
/* ESERCIZIO 6
  Usa un while loop per calcolare la massa totale dell'equipaggio. Salvala in una variabile chiamata "crewMass".
*/

let crewMasses = starWarsCharacters.mass;
console.log(crewMasses);
